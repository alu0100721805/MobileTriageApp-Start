...
public class Activity_Step5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__step5);
        Button yes_ = findViewById(R.id.bt_yes_step5);
        Button no_ = findViewById(R.id.bt_no_step5);
        Button main_ = findViewById(R.id.bt_main_step5);
    ...
    public void onClick(View v)
    {
        ...
        if (v != null) {
            ...
            if (v.getId() == id_bt_main_) {
                ...
                DataNFC dato = new DataNFC(colores[2]);
