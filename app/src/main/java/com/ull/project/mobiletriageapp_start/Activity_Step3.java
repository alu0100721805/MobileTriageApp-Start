...
public class Activity_Step3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__step3);
        Button yes_ =  findViewById(R.id.bt_yes_step3);
        Button no_ =  findViewById(R.id.bt_no_step3);
        Button main_ = findViewById(R.id.bt_main_step3);
    ...
    public void onClick(View v){
        ...
        if(v != null)
        {
            ...
            if (v.getId() == id_bt_main_)
            {
                ...
                try{
                    Intent i = new Intent(this,Activity_Step4.class);
                    startActivity(i);
                }
                catch (Exception e){
