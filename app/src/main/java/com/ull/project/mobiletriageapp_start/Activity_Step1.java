...
public class Activity_Step1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__step1);
        Button yes_ = findViewById(R.id.bt_yes_step1);
        Button no_ = findViewById(R.id.bt_no_step1);
        Button main_ = findViewById(R.id.bt_main_step1);
    ...
    public void onClick(View v){
        ...
        if(v != null)
        {
            if ( v.getId() == id_bt_main_)
            {
                ...
                DataNFC dato = new DataNFC(colores[3]);
                i.putExtra("Datos",dato);
                startActivity(i);

            }else if (v.getId() == id_bt_no_){
                Intent i = new Intent(this,Activity_Step2.class);
                startActivity(i);
